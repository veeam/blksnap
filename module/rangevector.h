...
struct blk_range_tree_node *blk_range_rb_iter_first(struct rb_root_cached *root,
	sector_t start, sector_t last);

struct blk_range_tree_node *blk_range_rb_iter_next(struct blk_range_tree_node *node,
	sector_t start, sector_t last);
