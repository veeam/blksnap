...
int snapstore_device_read(snapstore_device_t *snapstore_device,
			  blk_redirect_bio_t *rq_redir); //request from image
int snapstore_device_write(snapstore_device_t *snapstore_device,
			   blk_redirect_bio_t *rq_redir); //request from image
