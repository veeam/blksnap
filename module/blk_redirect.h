...
int blk_dev_redirect_memcpy_part( blk_redirect_bio_t* rq_redir, int direction, void* src_buff, sector_t rq_ofs, sector_t rq_count );
int blk_dev_redirect_zeroed_part( blk_redirect_bio_t* rq_redir, sector_t rq_ofs, sector_t rq_count );

int blk_dev_redirect_read_zeroed( blk_redirect_bio_t* rq_redir, struct block_device* blk_dev, sector_t rq_pos, sector_t blk_ofs_start, sector_t blk_ofs_count, rangevector_t* zero_sectors );
...
#define redirect_bio_queue_empty( queue ) \
