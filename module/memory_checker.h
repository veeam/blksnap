...
#ifndef __BLKSNAP_MEMORY_CHECKER_H
#define __BLKSNAP_MEMORY_CHECKER_H
...
enum memory_object_type {
	...
	memory_object_chunk,
	memory_object_blksnap_snapshot_event,
	...
	/*kcalloc*/
	memory_object_blksnap_cbt_info,
	memory_object_blksnap_block_range,
	memory_object_blksnap_dev_t,
...
{};
#endif
#endif /* __BLKSNAP_MEMORY_CHECKER_H */
